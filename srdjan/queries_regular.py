...
# Query for Dedicated Fans of "Goat Simulator" Series
...
def execute_query(collection, query, timeout=3600):
...
log_query_execution("Dedicated Fans of 'Goat Simulator' Series",
